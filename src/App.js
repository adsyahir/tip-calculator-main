...
function App() {
 // State to store value from the input field
  ...
  const [inputValue4, setInputValue4] = useState("Custom");
  ...
  const handleChangeCustomTip = (e) => {
    setInputValue3(e.target.value/100);
  ...
  var myNumberWithTwoDecimalPlaces1=parseFloat(((inputValue1*inputValue3)/inputValue2)+1).toFixed(2);
  ...
  return (
    <div className="container">
     <div class="box-1 padding">
       ...
       <input type="number" name="bill" value={inputValue1} onChange={handleUserInput1} className="input-text">
       ...
       <input type="number"  onChange={handleChangeCustomTip }  className="input-text-1" placeholder="Custom" />
       </div>
       ...
       <input type="number" name="people" value={inputValue2}  onChange={handleUserInput2} className="input-text">
     ...
     <div className="row between" style={{marginBottom:'50px'}}>
       ...
       <input type="number" onChange={myNumberWithTwoDecimalPlaces} value={myNumberWithTwoDecimalPlaces} placeholder="0.00" readOnly></input>
     </div>
     <div className="row between"  style={{marginBottom:'150px'}}>
       <ul>
         <li>
           <h4>Total</h4>
           <p>/ person</p>
       ...
       <input type="number" onChange={myNumberWithTwoDecimalPlaces1} value={myNumberWithTwoDecimalPlaces1} placeholder="0.00" readOnly></input>
       
     </div>
     <input type="reset" onClick={resetInputField}>
