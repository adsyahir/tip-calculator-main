...
function App() {
 // State to store value from the input field
  ...
  const[appState,changeState]=useState({
    activeObject: null,
    objects: [{percent:'5%',id:0},{percent:'10%',id:1},{percent:'15%',id:2},{percent:'25%',id:3},{percent:'50%',id:4}]
  })
  ...
  var myNumberWithTwoDecimalPlaces=parseFloat((inputValue1*inputValue3)/inputValue2).toFixed(2);
  var myNumberWithTwoDecimalPlaces1=parseFloat(((inputValue1*inputValue3)/inputValue2)+(inputValue1/inputValue2)).toFixed(2);
  ...
  return (
    <div className="container">
     <div class="box-1 padding">
       ...
       <input type="number" id="bill" name="bill" value={inputValue1} min="1"  onChange={handleUserInput1} className="input-text" placeholder="0">
       ...
       {appState.objects.map((elements,index) => (
         <button 
          ...
          value={index}
          >{elements.percent} </button>
       ))}

       <input type="number" id="tip"  onChange={handleChangeCustomTip} min="1"  value={inputValue4} placeholder="Custom" className="input-text-1"  />
       </div>
       ...
       <input type="number" id="people" name="people" value={inputValue2} min="1"  onChange={handleUserInput2} className="input-text" placeholder="0">
     ...
     <div className="row between" style={{marginBottom:'50px'}}>
       ...
       <input type="number" class="input-readonly" onChange={myNumberWithTwoDecimalPlaces} value={myNumberWithTwoDecimalPlaces} placeholder="0.00" readOnly></input>
     </div>
     <div className="row between"  style={{marginBottom:'30%'}}>
       ...
       <input type="number" class="input-readonly"  onChange={myNumberWithTwoDecimalPlaces1} value={myNumberWithTwoDecimalPlaces1} placeholder="0.00" readOnly></input>
       
     </div>
     <button type="reset" class="reset" onClick={resetInputField} disabled={
